...
exports.lineSegmentsIntersect= function(start1, end1, start2, end2) {
   var denom = ((end1[0] - start1[0]) * (end2[1] - start2[1])) - ((end1[1] - start1[1]) * (end2[0] - start2[0]));
   if (denom === 0) {
      return false;
   }

   var numer = ((start1[1] - start2[1]) * (end2[0] - start2[0])) - ((start1[0] - start2[0]) * (end2[1] - start2[1]));
   var r = numer / denom;
   if (r < 0 || r > 1) {
      return false;
   }

   var numer2 = ((start1[1] - start2[1]) * (end1[0] - start1[1])) - ((start1[0] - start2[0]) * (end1[1] - start1[1]));
   var s = numer2 / denom;
   if (s < 0 || s > 1) {
      return false;
   }
